  ...
  return (
    <div>
      ...
      <p className="p">
        ...
        rendimiento. Superá tu mejor marca personal. Feltwell es el hogar del
        ...
        <div className="gallery">
          <div className="gallery-item">
            <img
              ...
              src="https://i.imgur.com/xSu3eug.jpg"
          ...
          <div className="gallery-item">
            <img
              className="gallery-image"
              src="https://i.imgur.com/tNjMXYX.jpg"
          ...
          <div className="gallery-item">
            <img
              className="gallery-image"
              src="https://i.imgur.com/lfBm5GC.jpg"
          ...
          <div className="gallery-item">
            <img
              className="gallery-image"
              src="https://i.imgur.com/mjSiotF.jpg"
          ...
          <div className="gallery-item">
            <img
              className="gallery-image"
              src="https://i.imgur.com/Ehq3KCQ.jpg"
          ...
          <div className="gallery-item">
            <img
              className="gallery-image"
              src="https://i.imgur.com/5ejAjWU.jpg"
